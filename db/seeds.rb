...
project_data = [
  {:title => ["Chess Game", 
    ...
    :description => ["This is a React and Rails app that utilizes a third-party drag and drop library to play chess. It is still in progress, but most piece movements are programmed. I'd love some help to finish this!",
      ...
      "This is a kind of Air BnB clone. Backend includes a relational database of properties, renters, property owners, and locations. Currently hooking in various APIs, like Google Maps and creating a custom UI overlay for it.",
