titles  = ["Chess Game", 
  ...
  "GymBattles"]
  pictures = [
    "https://res.cloudinary.com/lifeafterdev/image/upload/v1612327885/project%20photos/chess_bibu3r.jpg",
  ...
  descriptions = ["This is a React and Rails app that utilizes a third-party drag and drop library to play chess. It is still in progress, but most piece movements are programmed. I'd love some help to finish this!",
  ...
  6.times do 
    4.times do
      projects.push(Project.create(title: titles[i], picture: pictures[i], description: descriptions[i], user_id: j, live_link: "http://google.com", github_link: "https://github.com/devpointlabs/life-after-dev"))
      i += 1
    end
    j += 1
  end
